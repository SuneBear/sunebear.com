...
// Static Methods
Random.nextSeed = function nextSeed(isTrueRandom) {
  const out = new Uint16Array(4)
  for (let i = 0; i < 4; i++) {
    out[i] = isTrueRandom ? Math.random() * 0x10000 : SEED_PCG.next() * 0x10000
  }
  return out
}
...
export const random = Random(SEED_STATE)
